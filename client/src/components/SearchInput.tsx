  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        data-testid={testId}
        className="w-full rounded-xl border border-ink/10 bg-paper-light py-2.5 pr-9 pl-9 font-sans text-sm text-ink placeholder:text-ink-soft focus:outline-none focus:ring-2 focus:ring-teal"
      />
      {value && (
        <button
          type="button"
